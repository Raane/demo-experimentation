(function(global) {
  class ZentangleVisionShaderNode extends NIN.ShaderNode {
    constructor(id, options) {
      ...
      this.z1 = Loader.loadTexture('res/z1.jpg');
      this.z2 = Loader.loadTexture('res/z2.png');
      this.z3 = Loader.loadTexture('res/z8.png');
      this.z4 = Loader.loadTexture('res/z10.jpg');
      this.z5 = Loader.loadTexture('res/z11.jpg');
      this.z6 = Loader.loadTexture('res/z12.jpg');
      //console.log(this.z1);
    }
    ...
    update(frame) {
      if (frame % 200 < 100)
      {
        ...
        //this.uniforms.tDiffuse.value = this.test;
